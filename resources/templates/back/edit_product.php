...
<div class="form-group">
    ...
    <div class="form-group">
      ...
      <textarea name="product_description" id="" cols="30" rows="10" class="form-control" required="required"><?php echo $product_description;?></textarea>
    </div>
    ...
    <div class="form-group">
      ...
      <textarea name="short_desc" id="" cols="30" rows="3" class="form-control" required="required" value=""><?php echo $short_desc; ?></textarea>
    </div>
...
<!-- Product Tags -->
    ...
    <div class="form-group">
        ...
        <img width="200" src="../../resources/<?php echo $image;?>"></img>
    </div>
